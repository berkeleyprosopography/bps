...
<h2>Step 1A: Consider the roles of persons </h2>
  ...
  <tr class="paramDesc">
    ...
    <td class="paramData" >
      <select class="bpsFormInput">
       <option selected="1" value="1">Yes</option>
       <option value="0">No</option>
      </select>    </td>
    <td class="paramData" ><select name="select" class="bpsFormInput">
...
<h2>Step 1B: Consider equally qualified names</h2>
...
<table cellpadding="10px" class="params">
  ...
  <tr>
    ...
    <td class="paramDesc"><select name="select12" class="bpsFormInput">
  ...
  <tr>
    ...
    <td class="paramDesc"><select name="select13" class="bpsFormInput">
...
<h2>Step 1C: Consider compatible, but not equally qualified names</h2>
	<table cellpadding="10px" class="params">
  <tr>
 ...
 &quot;<b><i>PN<sub>a</sub></i></b>&quot;<b><i></i> </b> and<b> </b>&quot;<b><i>PN<sub>a</sub>, son-of PN<sub>b</sub></i></b>&quot;)</td>
  ...
  <h3><i>Rule Steps 2A, 2B, and 2C collapse citations among different documents.</i></h3>
  <h2>Step 2A: Consider the roles of persons </h2>
  <p>Note that &quot;ancestors&quot; includes all fathers, mothers, grandfathers, and other declared ancestors. </p>
  <table cellpadding="10px" class="params">
  <tr><td colspan="4" class="caseTitle">
  ...
  <h2>Step 2B: Consider equally qualified names</h2>
  <table cellpadding="10px" class="params">
    <tr>
      <td class="paramDesc"><b>Collapse equal, fully qualified citations&nbsp;<br />
      ...
      <td class="paramDesc"><select name="select14" class="bpsFormInput">
  ...
  <h2>Step 2C: Consider compatible, but not equally qualified names</h2>
  <table cellpadding="10px" class="params">
    <tr>
      <td class="paramDesc"><b>Collapse partly qualified citations with compatible, fully qualified citations <br />
      </b> (e.g., &quot;<b><i>PN<sub>a</sub>, son-of PN<sub>b</sub></i></b>&quot;<b><i></i> </b> and<b> </b>&quot;<b><i>PN<sub>a</sub>, son-of PN<sub>b</sub>,  in-clan CN<sub>c</sub></i></b>&quot;<b><i></i></b>)</td>
