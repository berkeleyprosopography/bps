INSERT INTO role( id, name, description, creation_time ) VALUES 
   ...
   ( 2, 'WorkspaceOwner', 'Owner/admin of a workspace. Has all rights over workspace, and can grant others rights on workspace.', now() ),
   ( 3, 'Viewer', 'An authenticated user of the system with workspace read rights.', now() ),
   ( 4, 'Collaborator', 'An authenticated user of the system with workspace read and update rights.', now() );
